...
public class ExecuteOrderTest {
    ...
    public void testExecuteOrders() {
        ...
        String expectedOutput = "Order executed: " + d_Order1.getOrderDetails() + "\n" +
                "3 Armies have been deployed in " + d_Order1.getOrderDetails().getCountryDestination() + "\n" +
                "Order executed: " + d_Order2.getOrderDetails() + "\n" +
                "2 Armies have been deployed in " + d_Order2.getOrderDetails().getCountryDestination() + "\n";
    ...
    public void testExecuteOrder() {
        ...
        assertTrue(result);
        String expectedOutput = "3 Armies have been deployed in " + d_Order1.getOrderDetails().getCountryDestination() + "\n" +
                "\nHoorayyy, The Execution has been completed successfully: 3 armies deployed to " + d_Order1.getOrderDetails().getCountryDestination() + ".\n" +
                "=========================================================================================\n";
        assertEquals(expectedOutput, getConsoleOutput());
